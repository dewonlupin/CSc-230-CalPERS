...
if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
    header("location: Home/Signature.php");
    exit;
}
...
<head>
    ...
    <!-- Title Page-->
    <title><img src="images/Calpers-logo.png" />Au Register Forms by Colorlib</title>
...
<img src="images/calpersLogo.jpg" style="height:100px;widht:150px;margin:-20px;margin-left:0px;" />
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text"  name="username"  value="<?php echo $email; ?>">
                                </div>
                            </div>
			...
			<div class="row"><p>Don't have an account? <a href="register.php">Sign up here</a>.</p></div>
                    </form>
                </div>
            </div>
        </div>
